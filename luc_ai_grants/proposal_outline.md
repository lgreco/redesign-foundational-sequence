# CFD Human-Centered AI Grant — Draft Proposal Outline

Status: draft outline, not yet submission-ready.
...
## 1. Project Description (300-word max)

Structure per CFP: (a) goals, (b) steps, (c) assessment plan, (d) rationale. Must address CFP themes and is strongly encouraged to name specific Ignatian Pedagogical Paradigm practices.
...
- **(c) Assessment plan**
  ...
  - Flag any instrument needing IRB consideration
- **(d) Rationale — Ignatian framing**
...
- Draw from `proposal_158_159/syllabus-158.md`, `syllabus-159.md`, and existing week-by-week plans
- TODO: lay out by semester/AY 2027–2028 milestones (build, pilot COMP 158 fall, pilot COMP 159 spring, assess, disseminate)
- Note flexibility allowed by CFP, but commit to a pilot/completion date inside AY 2027–2028

## 3. Budget and Justification

Allowed categories per CFP — draft line items against each:
...
TODO: attach dollar figures once scope is settled; cap at $20,000 for Programmatic category.
...
Per CFP, Faculty Advisory Board scores on:
1. Alignment to CFP
2. Innovation
3. Broader impact
4. Feasibility
